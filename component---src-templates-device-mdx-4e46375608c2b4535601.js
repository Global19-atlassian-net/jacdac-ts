...
function DeviceDTDLSnippet(props) {
  ...
  var dtdl = Object(react["useMemo"])(function () {
    return JSON.stringify(Object(azure_iot_dtdl["c" /* deviceSpecificationToDTDL */])(dev, {
...
function DeviceSpecification(props) {
  ...
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("h2", {
    ...
    to: "/devices/" + Object(jdom_spec["h" /* identifierToUrlPath */])(Object(jdspec["e" /* escapeDeviceIdentifier */])(device.company))
  }, device.company)), /*#__PURE__*/react_default.a.createElement("img", {
    alt: "image of the device",
    src: Object(jdom_spec["i" /* imageDeviceOf */])(device)
    ...
    return Object(jdom_spec["H" /* serviceSpecificationFromClassIdentifier */])(sc);
  }).map(function (spec) {
...
//# sourceMappingURL=component---src-templates-device-mdx-4e46375608c2b4535601.js.map